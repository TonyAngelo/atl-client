    ...
    <main>
      ...
      {jumboOn
        ...
        <Col md={4}>
          ...
          <div className="mb-4">
            {Object.keys(categoryIDs).map((item, index) => <Link key={index} to={"/category/"+item}><Badge className="categoryLink m-2" variant={categoryBadge[categoryIDs[item]]}>{categoryNames[categoryIDs[item]]}</Badge></Link>)}
          </div>
